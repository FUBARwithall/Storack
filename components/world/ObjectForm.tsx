...
import { createWorldObject, updateWorldObject } from "@/lib/actions";
...
export function ObjectForm({ worldId, worldName, storyId, stories = [], entry, onSave, onCancel }: ObjectFormProps) {
    ...
    useEffect(() => {
        if (entry) {
            setName(entry.name || "");
            setCategory(entry.category || "Artifact");
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isEdit) {
                await updateWorldObject(entry.id, data);
            } else {
                await createWorldObject(worldId, data);
            }
            onSave();
        } catch (error) {
    ...
    return (
        <Card className="max-w-5xl mx-auto">
            <CardHeader>
                <CardTitle>{isEdit ? "Edit Object" : "Create Object"}</CardTitle>
                <CardDescription>
                    Document a physical item (e.g. Artifact, Relic, Weapon, Vehicle) in your world.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="lg:col-span-7 flex flex-col justify-between gap-6">
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <Label htmlFor="name" className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Object Name</Label>
                                    <Input
                                        id="name"
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            id="category"
                                            placeholder="e.g. Weapon, Relic, Vehicle"
                                            value={category}
                    ...
                    <div className="space-y-2 pt-2">
                        ...
                        <Textarea
                            id="description"
                            placeholder="A brief summary or detailed specifications of this object..."
                            value={description}
                    ...
                    <div className="flex items-center justify-end gap-3 pt-6 border-t">
                        ...
                        >
                            ...
                            {isEdit ? "Update Object" : "Save Object"}
                        </Button>
                    </div>
                </form>
            </CardContent>
