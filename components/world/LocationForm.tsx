...
export function LocationForm({ worldId, storyId, stories = [], entry, onSave, onCancel }: LocationFormProps) {
    ...
    return (
        <Card className="max-w-5xl mx-auto">
            <CardHeader>
                <CardTitle>{isEdit ? "Edit Location" : "Create Location"}</CardTitle>
                <CardDescription>
                        ...
                        <div className="lg:col-span-7 flex flex-col justify-between gap-6">
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="mapUrl" className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Reference/Map URL (Optional)</Label>
                                        <Input
                                            id="mapUrl"
                                            placeholder="https://..."
                                            value={mapUrl}
